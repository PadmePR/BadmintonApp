    ...
    <div style={{
      ...
      <div onClick={toggle} style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--text)' }}>{date} · {time}</div>
                    ...
                    return (
                      <div key={m.id} style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                              ...
                              {teamA.map((id, i) => {
                                ...
                                return (
                                  <div key={id} style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                                    ...
                                    <span style={{
                                      fontSize: 12, fontWeight: winA ? 600 : 400,
                          ...
                          <span style={{ fontSize: 10, fontWeight: 600, color: 'var(--text-tertiary)', flexShrink: 0, paddingTop: 2 }}>vs</span>
                              ...
                              {teamB.map((id, i) => {
                                ...
                                return (
                                  <div key={id} style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                                    ...
                                    <span style={{
                                      fontSize: 12, fontWeight: winB ? 600 : 400,
